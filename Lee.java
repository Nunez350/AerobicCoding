...
8) For each student, call the generateID method with the student's corresponding index in the student array as the argument.
...
class Lee{
    public static void main(String args[]){
        String arr[] = {UndergraduateStudent, GraduateStudent, UndergraduateStudent};
    }
}